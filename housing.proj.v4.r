...
# Parameter Grids
XGB.grid <- expand.grid(nrounds = seq(1000, 2000, by = 100), 
                        max_depth = 6, 
                        eta = 0.01, 
                        gamma = 0.005, 
                        colsample_bytree = .5, 
...
MLP.grid <- expand.grid(layer1 = 10,
                        layer2 = 10,
                        layer3 = 10)
#------------------- MODELS ------------------#
...
XGB.model <- readRDS("XGB.House.model.rds")
...
modelTime <- xgbTime + gbmTime + rfTime + svmTime
modelTime
